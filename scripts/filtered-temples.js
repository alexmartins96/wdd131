...
const temples = [
    ...
    },
    {
        ...
        area: 49000,
        imageUrl: "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/draper-utah/800x500/draper-utah-lds-temple-942143-wallpaper.jpg"
    }
];

// ✅ Render function
function displayTemples(templeList) {
    const main = document.querySelector(".temple-grid");
    main.innerHTML = "<h2 class='page-title'>Temples</h2>";
    ...
    templeList.forEach(t => {
        ...
        date.textContent = `Dedicated: ${t.dedicated}`;
        ...
        card.append(h3, loc, date, area, img);
